    ...
    {
        {
            ...
            minable = { mining_time = 0.5, result = "advanced-chemical-plant" },
            max_health = 300,
            corpse = "big-remnants",
...

        {
            ...
            minable = { mining_time = 0.5, result = "ore-extractor" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "vacuum-chamber" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "planck-ripper" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "fish-farm" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-1" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-3" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-4" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-5" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-6" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-7" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-8" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-9" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "server-m" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "iron-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "copper-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "gold-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "uranium-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "stone-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "lead-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "iron-probe2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "copper-probe2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "gold-probe2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "uranium-probe2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "stone-probe2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "lead-probe2" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "diamond-probe" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation" },
            minable = { mining_time = 0.5, result = "brain-grower" },
            max_health = 400,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "placeable-player", "player-creation", "not-rotatable" },
            minable = { mining_time = 2.5, result = "biodome" },
            max_health = 10000,
            corpse = "big-remnants",
            dying_explosion = "medium-explosion",
            alert_icon_shift = util.by_pixel(-3, -12),
