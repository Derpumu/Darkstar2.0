    ...
    {
        {
            ...
            minable = { mining_time = 0.5, result = "large-lamp" },
            max_health = 250,
            corpse = "big-remnants",
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "red-lamp" },
            max_health = 100,
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "blue-lamp" },
            max_health = 100,
            corpse = "small-remnants",
            collision_box = { { -0, -0 }, { 0, 0 } },
            selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "yellow-lamp" },
            max_health = 100,
            corpse = "small-remnants",
            collision_box = { { -0, -0 }, { 0, 0 } },
            selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "green-lamp" },
            max_health = 100,
            corpse = "small-remnants",
            collision_box = { { -0, -0 }, { 0, 0 } },
            selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "purple-lamp" },
            max_health = 100,
            corpse = "small-remnants",
            collision_box = { { -0, -0 }, { 0, 0 } },
            selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "cyan-lamp" },
            max_health = 100,
            corpse = "small-remnants",
            collision_box = { { -0, -0 }, { 0, 0 } },
            selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
        ...
        },
        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "white-lamp" },
            max_health = 100,
            corpse = "small-remnants",
            collision_box = { { -0, -0 }, { 0, 0 } },
            selection_box = { { -0.5, -0.5 }, { 0.5, 0.5 } },
