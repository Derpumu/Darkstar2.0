    ...
    {
        {
            ...
            minable = { mining_time = 0.5, result = "advanced-accumulator" },
            max_health = 250,
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "flywheel" },
            max_health = 300,
            corpse = "medium-remnants",
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid" },
            max_health = 500,
            corpse = "medium-remnants",
            collision_box = { { -0.9, -0.9 }, { 0.9, 0.9 } },
            selection_box = { { -1, -1 }, { 1, 1 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-2" },
            max_health = 500,
            corpse = "medium-remnants",
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-3" },
            max_health = 500,
            corpse = "medium-remnants",
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-U" },
            max_health = 350,
            corpse = "medium-remnants",
            collision_box = { { -0.9, -0.9 }, { 0.9, 0.9 } },
            selection_box = { { -1, -1 }, { 1, 1 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-2-U" },
            max_health = 350,
            corpse = "medium-remnants",
            collision_box = { { -1, -1 }, { 1, 1 } },
            selection_box = { { -1, -1 }, { 1, 1 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-3-U" },
            max_health = 350,
            corpse = "medium-remnants",
            collision_box = { { -5, -7 }, { 9.3, 5.1 } },
            selection_box = { { -5.3, -7.4 }, { 9.7, 5.6 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-D" },
            max_health = 100,
            corpse = "medium-remnants",
            collision_box = { { -0.9, -0.9 }, { 0.9, 0.9 } },
            selection_box = { { -1, -1 }, { 1, 1 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-2-D" },
            max_health = 100,
            corpse = "medium-remnants",
            collision_box = { { -1, -1 }, { 1, 1 } },
            selection_box = { { -1, -1 }, { 1, 1 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "energy-liquid-3-D" },
            max_health = 100,
            corpse = "medium-remnants",
            collision_box = { { -5, -7 }, { 9.3, 5.1 } },
            selection_box = { { -5.3, -7.4 }, { 9.7, 5.6 } },
