    ...
    {
        {
            ...
            minable = { mining_time = 0.5, result = "solar-panel-mk2" },
            max_health = 900,
            corpse = "big-remnants",
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk4" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk5" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk6" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk7" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk2-G" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk3-G" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk4-G" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk5-G" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk6-G" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk7-G" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk2-G2" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk3-G2" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk4-G2" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk5-G2" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk6-G2" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk7-G2" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk2-G3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk3-G3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk4-G3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk5-G3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk6-G3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk7-G3" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk2-GL" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk3-GL" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk4-GL" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk5-GL" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk6-GL" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
...

        {
            ...
            icon_size = 32,
            flags = { "placeable-neutral", "player-creation" },
            minable = { mining_time = 0.5, result = "solar-panel-mk7-GL" },
            max_health = 900,
            corpse = "big-remnants",
            collision_box = { { -3.2, -2.6 }, { 3.2, 2.6 } },
            selection_box = { { -3.5, -3 }, { 3.5, 3 } },
